...
/*   Updated: 2025/01/29 14:34:58 by szhong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef EXECUTOR_H
# define EXECUTOR_H
...
void init_quote_state(t_shell *shell, const char *arg, bool *was_in_double_quotes);
...
int cmd_copy_remaining_args(char **dest, char **src, size_t dest_start, size_t count);
...
char *cmd_handle_variable_expansion(t_shell *shell, char *dollar_pos, char **var_end);
