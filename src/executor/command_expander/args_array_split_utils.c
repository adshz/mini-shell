...
static void copy_args_before_split(char **new_args, char **old_args, int split_pos)
{
	int j;
...
static void split_current_arg(char **new_args, char *arg, char *space_pos, int pos)
{
	*space_pos = '\0';
...
static void copy_remaining_args(char **new_args, char **old_args, int *i, int start_pos)
{
	int j;
