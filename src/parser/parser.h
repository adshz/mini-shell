...
t_ast_node *parse_redirection_construct(t_ast_node *cmd_node, t_token **tokens, t_shell *shell);
t_ast_node *process_consecutive_redirections(t_ast_node *node, t_token **tokens, t_shell *shell);
